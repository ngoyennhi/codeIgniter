...
// class ApiController va appliquer le méthode category avec parametre $1 get sa value à partir de (:alpha) -- c'est le technique de recuperer les parametres à partir URL 
$routes->get('/api/category/(:alpha)', "ApiController::category/$1");
$routes->get('/api/search/(:alpha)', "ApiController::search/$1");
$routes->get('/api/searchId/(:num)', "ApiController::searchId/$1");
